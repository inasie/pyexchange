...
class ExchangeBinanceTest(unittest.TestCase):
    ...
    def get_exchange(self):
        ...
        return exchange.create_exchange('OKEx')
    ...
    def test_get_ticker(self):
        ticker = self.get_exchange().get_ticker(CurrencyPair('BTC', 'LTC'))
        self.assertIsNotNone(ticker)
        logging.info(ticker)

    def test_get_orderbook(self):
        orderbook = self.get_exchange().get_orderbook(CurrencyPair('BTC', 'LTC'))
